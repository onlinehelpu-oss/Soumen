...
void DrawSLTPLines(double entry, double sl, double tp)
{
   ...
   ObjectSetInteger(0, prefix + "Entry", OBJPROP_COLOR, (long)clrYellow);
   ObjectSetInteger(0, prefix + "Entry", OBJPROP_STYLE, (long)STYLE_SOLID);

   ObjectCreate(0, prefix + "SL", OBJ_HLINE, 0, 0, sl);
   ObjectSetInteger(0, prefix + "SL", OBJPROP_COLOR, (long)clrRed);
   ObjectSetInteger(0, prefix + "SL", OBJPROP_STYLE, (long)STYLE_DASH);

   ObjectCreate(0, prefix + "TP", OBJ_HLINE, 0, 0, tp);
   ObjectSetInteger(0, prefix + "TP", OBJPROP_COLOR, (long)clrLime);
   ObjectSetInteger(0, prefix + "TP", OBJPROP_STYLE, (long)STYLE_DASH);
}
