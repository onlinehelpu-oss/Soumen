...
#property indicator_color1  C'0,168,133', C'235,83,83' // Teal/Green & Red matching TradingView/XM chart
...
//--- sets short name
   IndicatorSetString(INDICATOR_SHORTNAME,"Heiken Ashi Series");
   ...
   for(int i=limit-1; i>=0 && !IsStopped(); i--)
     {
      ...
      //--- set candle color
      if(ha_open<ha_close)
         ExtColorBuffer[i]=0.0; // Green/Teal
      else
         ExtColorBuffer[i]=1.0; // Red
     }
