...
# ===================== OTHER SETTINGS =====================
MARKET_START_TIME_NSE = dt.time(9, 15)
MARKET_START_TIME_MCX = dt.time(9, 0)
ONE_POSITION_AT_A_TIME = True # If True, the bot will only hold one position across all symbols.
EXIT_ALL_TIME_NSE = dt.time(15, 9) # Auto square-off time for INTRADAY positions on NSE
EXIT_ALL_TIME_MCX = dt.time(22, 50) # Auto square-off time for INTRADAY positions on MCX
